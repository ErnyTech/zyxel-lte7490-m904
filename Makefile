...
# START-need to remove for SDK release, don't remove this line!
.PHONY: release-sdk
release-sdk:
	make -s -w -f include/private/zyxel/zyxel-release.mk
# END-need to remove for SDK release, don't remove this line!
