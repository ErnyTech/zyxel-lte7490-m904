ReadMe for LTE7490-M904_Generic(V1.00(ABQY.6)C0)


0. Introduction

  This file will show you how to build the LTE7490-M904_Generic linux system,
...
1. Files list
   ...
   B.  V100ABQY6C0_GPL.tar.bz2	- Open Source Code of LTE7490-M904_Generic and Open Source Code of Toolchain
...
6. The image is in the images directory.
    ...
    You can use it update LTE7490-M904_Generic by using the firmware update procedure.
