...
tr98Parameter_t para_cellular[] = {
	{"X_ZYXEL_DisableUMTS",PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ "RoamingEnabled",PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ "NetworkMonitorEnabled",PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ NULL, 0, 0}
};
...
tr98Parameter_t para_cellularInterface[] = {
	...
	{ "SupportedServiceDomain", PARAMETER_ATTR_READONLY, 129, json_type_string },
	{ "PreferredServiceDomain", PARAMETER_ATTR_WRITE, 17,json_type_string},
	{ "SupportedAccessTechnologies", PARAMETER_ATTR_READONLY, 129, json_type_string },
	{ "PreferredAccessTechnology", PARAMETER_ATTR_WRITE, 17,json_type_string},
	{ NULL, 0, 0}
};
