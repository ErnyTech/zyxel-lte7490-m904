...
#define DNSMASQ_CUS_DHCP_OPT_CONF_FILE DNSMASQ_CONF_D "/cusDhcpOpt.conf"
...
#define DIAG_ERROR_REJECT_BY_REMOTE 	"Error_RejectedByRemote"
#define DIAG_ERROR_INCORRECT_SIZE		"Error_IncorrectSize"
#define DIAG_ERROR_LOGIN_FAILED			"Error_LoginFailed"
#define DIAG_ERROR_PASSWORD_REQ_FAILED	"Error_PasswordRequestFailed"
#define DIAG_ERROR_NO_ROUTE_TO_HOST		"Error_NoRouteToHost"
...
/* TR471 Error Messages*/
#ifdef ZYXEL_TR471_UDP_SPEED_TEST
#define TR471_ERROR_MESSAGE_GETADDRINFO    			"GETADDRINFO ERROR"
#define TR471_ERROR_MESSAGE_CONNECT		 			"CONNECT ERROR"
#define TR471_ERROR_MESSAGE_AUTHENTICATION_REQUIRED	"ERROR: Authentication required by server"
#define TR471_ERROR_MESSAGE_AUTHENTICATION_OTHER		"ERROR: Authentication"
#define TR471_ERROR_MESSAGE_REJECT					"ERROR: Requested test parameter(s) rejected by server"
#define TR471_ERROR_MESSAGE_JUMBO_SIZE_NOT_MATCH		"ERROR: Client jumbo datagram size option does not match server"
#define TR471_ERROR_MESSAGE_MTU_NOT_MATCH				"ERROR: Client traditional MTU option does not match server"
#define TR471_ERROR_MESSAGE_MEMORY_ALLOCATION_FAIL	"ERROR: Memory allocation"
#define TR471_ERROR_MESSAGE_PROTO_VERSION_NOT_MATCH	"ERROR: Client version"
#define TR471_ERROR_MESSAGE_MAX_BANDWIDTH_EXCEED		"ERROR: Required max bandwidth exceeds available server capacity"
#define TR471_ERROR_MESSAGE_IP_TOS_TCLASS				"ERROR: Failure setting IP ToS/TClass"
#define TR471_ERROR_MESSAGE_ADDR_FAMILY_NOT_MATCH		"ERROR: Specified IP address does not match address family"
#define TR471_ERROR_MESSAGE_SENDING_RATE_TABLE_BUILD_FAIL		"ERROR: Sending rate table build failure (overrun)"
#define TR471_ERROR_MESSAGE_TIMEOUT_WATING_SERVER_RESPONSE	"Timeout awaiting server response, exiting!"
#endif
