...
#endif
extern tr98Parameter_t para_IPPTTrustDomain[];
extern tr98Parameter_t para_IPPTSrv[];
/*Handler Function*/
...
#endif
/*InternetGatewayDevice.X_ZYXEL_EXT.RemoteManagement_IP_PassThrough.Service.i */
extern zcfgRet_t zyExtIPPTSrvObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t zyExtIPPTSrvObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj);
extern zcfgRet_t zyExtIPPTSrvObjAdd(char *tr98FullPathName, int *idx);
extern zcfgRet_t zyExtIPPTSrvObjDel(char *tr98FullPathName);
extern zcfgRet_t zyExtIPPTSrvObjNotify(char *, char *, struct json_object *, int, struct json_object **);
extern int zyExtIPPTSrvObjAttrGet(char *, int, char *);
extern zcfgRet_t zyExtIPPTSrvObjAttrSet(char *, int, char *, int , struct json_object *);

/* InternetGatewayDevice.X_ZYXEL_EXT.RemoteManagement_IP_PassThrough.TrustDomain.i */
extern zcfgRet_t zyExtIPPTTrustDomainObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t zyExtIPPTTrustDomainObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj);
extern zcfgRet_t zyExtIPPTTrustDomainObjAdd(char *tr98FullPathName, int *idx);
extern zcfgRet_t zyExtIPPTTrustDomainObjDel(char *tr98FullPathName);
