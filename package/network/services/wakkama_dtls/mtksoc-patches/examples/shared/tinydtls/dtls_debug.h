...
#include "zlog_api.h"//Jessie
#include "zcfg_debug.h"//Jessie
...
//#define dtls_emerg(...) zcfgLogPrefix(ZCFG_LOG_EMERG, ZCFG_LOGPRE_LWM2M, __VA_ARGS__)
#define dtls_alert(...) dsrv_log(DTLS_LOG_ALERT, __VA_ARGS__)
//#define dtls_alert(...) zcfgLogPrefix(ZCFG_LOG_ALERT, ZCFG_LOGPRE_LWM2M, __VA_ARGS__)
#define dtls_crit(...) dsrv_log(DTLS_LOG_CRIT, __VA_ARGS__)
//#define dtls_crit(...) zcfgLogPrefix(ZCFG_LOG_ERR, ZCFG_LOGPRE_LWM2M, __VA_ARGS__)
#define dtls_warn(...) dsrv_log(DTLS_LOG_WARN, __VA_ARGS__)
//#define dtls_warn(...) zcfgLogPrefix(ZCFG_LOG_WARNING, ZCFG_LOGPRE_LWM2M, __VA_ARGS__)
#define dtls_notice(...) dsrv_log(DTLS_LOG_NOTICE, __VA_ARGS__)
//#define dtls_notice(...) zcfgLogPrefix(ZCFG_LOG_NOTICE, ZCFG_LOGPRE_LWM2M, __VA_ARGS__)
#define dtls_info(...) dsrv_log(DTLS_LOG_INFO, __VA_ARGS__)
//#define dtls_info(...) zcfgLogPrefix(ZCFG_LOG_INFO, ZCFG_LOGPRE_LWM2M, __VA_ARGS__)
#define dtls_debug(...) dsrv_log(DTLS_LOG_DEBUG, __VA_ARGS__)
//#define dtls_debug(...) zcfgLogPrefix(ZCFG_LOG_DEBUG, ZCFG_LOGPRE_LWM2M, __VA_ARGS__)
