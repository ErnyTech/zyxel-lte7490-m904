...
#ifdef ZYXEL_WEB_GUI_CELLWAN_SUPPORT_SERVICE_DOMAIN		
	printf("\nService Domain:\n");
	if(!strcmp("",json_object_get_string(json_object_object_get(obj, "INTF_Preferred_Service_Domain"))))
		printf("%-30s %-10s\n","Preferred Service Domain:", "N/A");
	else
		printf("%-30s %-10s\n","Preferred Service Domain:", json_object_get_string(json_object_object_get(obj, "INTF_Preferred_Service_Domain")));		
#endif
