...
extern dal_param_t BACKUP_RESTORE_param[];
#endif
...
#ifdef ZYXEL_PARTIAL_RESET
extern zcfgRet_t zcfgFeDalBackupRestore(const char *method, struct json_object *Jobj,  struct json_object *Jarray, char *replyMsg);
extern void zcfgFeDalShowBackupRestore(struct json_object *Jarray);
#endif
...
#endif
#ifdef ZYXEL_PARTIAL_RESET
{"backupRestore_config", BACKUP_RESTORE_param, 	zcfgFeDalBackupRestore,		zcfgFeDalShowBackupRestore,		"get|edit", 			"BackupRestore"},
#endif
