...
tr98Parameter_t para_TempSt[] = {
	{ "TemperatureSensorNumberOfEntries", PARAMETER_ATTR_READONLY, 0, json_type_uint32},
	{ NULL, 0, 0, 0}
};

tr98Parameter_t para_TempStSensor[] = {
	{ "Value", PARAMETER_ATTR_READONLY, 0, json_type_int},
	{ NULL, 0, 0, 0}
};
#endif
