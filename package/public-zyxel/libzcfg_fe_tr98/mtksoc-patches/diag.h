...
extern tr98Parameter_t para_IpLayerCapMetrics[];
extern tr98Parameter_t para_IpLayerIncreRes[];
extern tr98Parameter_t para_IpLayerModalRes[];
#endif
/*Handler Function*/
...
#ifdef ZYXEL_TR471_UDP_SPEED_TEST
/* InternetGatewayDevice.IPLayerCapacityMetrics */
extern zcfgRet_t ipLayerCapMetricsObjGet(char *, int, struct json_object **, bool);
extern zcfgRet_t ipLayerCapMetricsObjSet(char *, int, struct json_object *, struct json_object *);

/* InternetGatewayDevice.IPLayerCapacityMetrics.IncrementalResult */
extern zcfgRet_t ipLayerIncreResObjGet(char *, int, struct json_object **, bool);

/* InternetGatewayDevice.IPLayerCapacityMetrics.ModalResult */
extern zcfgRet_t ipLayerModalResObjGet(char *, int, struct json_object **, bool);
#endif
