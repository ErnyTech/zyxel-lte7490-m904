...
extern tr98Parameter_t para_WANCellIntfConf[];
extern tr98Parameter_t para_WANCellIntfConfStat[];
extern tr98Parameter_t para_WANCellAccessPoint[];
#endif
...
#endif
#ifdef CONFIG_LTE_SUPPORT
/* InternetGatewayDevice.WANDevice.i.X_ZYXEL_WANCellInterfaceConfig*/
extern zcfgRet_t WANCellIfaceCfgObjGet(char *, int, struct json_object **, bool);
extern zcfgRet_t WANCellIfaceCfgObjSet(char *, int, struct json_object *, struct json_object *);
/* InternetGatewayDevice.WANDevice.i.X_ZYXEL_WANCellInterfaceConfig.Stats*/
extern zcfgRet_t WANCellIfaceCfgStObjGet(char *, int, struct json_object **, bool);
/* InternetGatewayDevice.WANDevice.i.X_ZYXEL_WANCellAccessPoint*/
extern zcfgRet_t WANCellAccessPointObjGet(char *, int, struct json_object **, bool);
/* InternetGatewayDevice.WANDevice.i.X_ZYXEL_WANCellAccessPoint*/
extern zcfgRet_t WANCellAccessPointObjSet(char *, int, struct json_object **, bool);
#endif
