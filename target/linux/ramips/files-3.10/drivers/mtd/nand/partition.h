...
#define MTD_WWAN_PART_SIZE      0x100000	//1MB wwan partition size define for nand flash
#define MTD_DATA_PART_SIZE      0x1000000	//16MB data partition size define for nand flash
#define MTD_ROMD_PART_SIZE      0x100000	//1MB rom-d partition size define for nand flash
#define MTD_RESERVE_PART_SIZE   0x80000	//512k reserve partition size define for nand flash
