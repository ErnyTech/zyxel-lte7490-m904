...
static const struct usb_device_id option_ids[] = {
	{ USB_DEVICE(QUECTEL_VENDOR_ID, 0x0125) }, /*Quectel EC25/EC2.0 R2.0*/
	{ USB_DEVICE(QUECTEL_VENDOR_ID, 0x0306) }, /*Quectel EP06/EG06*/
  { USB_DEVICE(QUECTEL_VENDOR_ID, 0x0512) }, /*Quectel EG12/EM12/EP12*/
	{ USB_DEVICE(QUECTEL_VENDOR_ID, 0x0800) }, /* Quectel RG500 */
...
#if 1 //Add for Quectel. Fix USB hubs lost power when entering sleep mode.
			...
			const struct usb_device_id *id)
{
  ...
  #if 1 //Add for Quectel USB Remote wakeup
  if (serial->dev->descriptor.idVendor == cpu_to_le16(0x2C7C))
  {
