...
ECNT_UTILITY_LIB=-lcares -liconv -lcharset -lecntutility
export ECNT_UTILITY_LIB

LIBINSTALL_CFLAGS=
LIBINSTALL_CFLAGS+= -I$(LIB_INSTALL_DIR) -I$(LIB_DIR)
export LIBINSTALL_CFLAGS

LIBINSTALL_LDFLAGS=
LIBINSTALL_LDFLAGS+= -L$(LIB_INSTALL_DIR) -L$(LIB_DIR) $(PATH_LINK)
...
TC_CFLAGS+= -DTCSUPPORT_CPU_EN7521
TC_CFLAGS+= -DTCSUPPORT_CPU_EN7527
TC_CFLAGS+= -DTCSUPPORT_CPU_EN7528
TC_CFLAGS+= -DTCSUPPORT_MIPS_1004K
TC_CFLAGS+= -DTCSUPPORT_MT7510_FE
TC_CFLAGS+= -DTCSUPPORT_MT7530_SWITCH_API
TC_CFLAGS+= -DTCSUPPORT_DRIVER_API
...
TC_CFLAGS+= -DTCSUPPORT_UART1_ENHANCE
TC_CFLAGS+=-DTCSUPPORT_WLAN_SW_RPS
TC_CFLAGS+= -DTCSUPPORT_THERMAL_SENSOR
...
TC_CFLAGS+= -DTCSUPPORT_PARALLEL_NAND
endif
endif
...
TC_CFLAGS+=-DTCSUPPORT_4_4_KERNEL
endif
export KERNEL_CONF
...
ifneq ($(strip $(TCSUPPORT_2_6_36_KERNEL)),)
TC_CFLAGS+=-I$(KERNEL_ECNT_INC_DIR) -I$(KERNEL_DIR)/drivers/mtd/ralink
else
...
#0: disable, 1: AES-ECB
ifneq ($(strip $(TCSUPPORT_SECURE_BOOT_AES)),)
...
TC_CFLAGS+=-DTCSUPPORT_NAND_FLASH_OTP
endif
...
TC_CFLAGS+=-DTCSUPPORT_MIPS_SYNCTYPE10
...
TC_CFLAGS+=-DTCSUPPORT_TEST_VWTEST
endif
endif
endif
...
ifneq ($(strip $(TCSUPPORT_DUAL_WLAN_MT7613E)),)
TC_CFLAGS+=-DMT7613E -DBBUTOWBU -DTCSUPPORT_DUAL_WLAN -DTCSUPPORT_WLAN_AC
export TCSUPPORT_DUAL_WLAN_MT7613E
endif
ifneq ($(strip $(TCSUPPORT_WLAN_MT7915D)),)
TC_CFLAGS+=-DMT7915D -DTCSUPPORT_WLAN_MT7915D -DMT7915N -DMT7915E -DBBUTOWBU -DTCSUPPORT_DUAL_WLAN -DTCSUPPORT_WLAN_AC -DTCSUPPORT_WLAN_AX -DTCSUPPORT_WLAN_WPA3
...
TC_CFLAGS+=-DTCSUPPORT_RA_HWNAT -DTCSUPPORT_HWNAT_V3 -I$(MODULES_RA_HWNAT_V3_DIR)
endif
...
TC_CFLAGS+=-DTCSUPPORT_NOR_FLASH_USED
endif
...
TC_CFLAGS+=-DTCSUPPORT_RESERVEAREA_BLOCK=9
...
TC_CFLAGS+=-DTCSUPPORT_WLAN_MT7613_BUILD_IN
...
TC_CFLAGS+=-DTCSUPPORT_WLAN_MT7915_BUILD_IN
